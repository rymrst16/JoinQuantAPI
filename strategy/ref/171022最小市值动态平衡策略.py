#https://www.joinquant.com/post/267?tag=algorithm
def initialize(context):
    ...
    set_universe(get_index_stocks('000001.XSHG','2015-12-08')+get_index_stocks('399106.XSHE','2015-12-08'))
    #get_index_stocks获取一个指数给定日期在平台可交易的成分股列表，请点击（https://www.joinquant.com/indexData）查看指数信息
